 ...
 * @param event H3Event to pass for authentication headers.
 ...
 */
async function fetchUserCalendarFromLeetCode(event: H3Event, username: string, year: number): Promise<UserCalendar | null> {
 ...
 */
async function fetchUserContestRankingFromLeetCode(event: H3Event, username: string): Promise<UserContestRanking | null> {
 ...
 */
async function fetchUserLanguageProblemCountFromLeetCode(event: H3Event, username: string): Promise<LanguageProblemCount[] | null> {
 ...
 */
async function fetchUserQuestionProgressFromLeetCode(event: H3Event, username: string): Promise<UserQuestionProgress | null> {
 ...
 * @param event H3Event to pass for authentication headers (not typically needed for this query, but good practice).
 * @returns An array of all question counts by difficulty or null.
 */
async function fetchAllProblemsCountFromLeetCode(event: H3Event): Promise<AllQuestionsCount[] | null> {
 ...
 * @param event H3Event to pass for authentication headers (not typically needed).
 * @returns Daily coding challenge question data or null.
 */
async function fetchDailyCodingChallengeQuestionFromLeetCode(event: H3Event): Promise<DailyChallengeQuestion | null> {
 ...
 */
async function fetchStreakCounterFromLeetCode(event: H3Event): Promise<StreakCounter | null> {
 ...
 */
async function fetchCreatedPublicFavoriteListFromLeetCode(event: H3Event, userSlug: string): Promise<CreatedPublicFavoriteList | null> {
 ...
 */
async function fetchTagProblemCountsFromLeetCode(event: H3Event, username: string): Promise<TagProblemCounts | null> {
 ...
 */
async function fetchUserStatusFromLeetCode(event: H3Event): Promise<UserStatus | null> {
